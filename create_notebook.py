...
with open("predicting-fifa-2026-world-cup-with-ml.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)

print("Jupyter notebook 'predicting-fifa-2026-world-cup-with-ml.ipynb' successfully generated!")
